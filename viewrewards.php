	...
	<div class="collapse navbar-collapse top-nav w3l" id="bs-example-navbar-collapse-1">
		<ul class="nav navbar-nav linkEffects linkHoverEffect_11 custom-menu">
                    <li ><a href="index.php"><span>home</span></a></li>
                        ...
                        <li class="agile_active"><a href="viewrewards.php"><span>Rewards</span></a></li>
...
<div class="container" id="rewards"><br/><br/><br/>
        ...
        $q="select * from tbl_reward where status='0'";
                ...
                if(mysql_num_rows($res)==0){
                             echo "<h4 style=color:red;text-align:center;padding-top:5em;padding-bottom:5em;>No Rewards Found</h4>";
                }
                else{ ?>
