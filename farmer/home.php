...
<div class="container" id="login"><br/>
        ...
        $q2="SELECT * FROM `tbl_query` where fid='$fid' order by qid desc";
                ...
                while($row=  mysql_fetch_array($res)){
                    $res4=  mysql_query("SELECT catname FROM `tbl_category`
...
WHERE tbl_query.`qid`='$row[qid]'");
                    ...
                    . "$row[query]  <a href='viewreplies.php?id=$row[qid]' style='float:right;' class='btn btn-success'>View Replies</a> </ul>";
