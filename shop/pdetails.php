...
<!-- //menu -->
        ...
        <div class="container" id="body"><br/><br/>
             <h5 style="padding-top:.5em">Add Product</h5><hr/>
            ...
            <center>
                <table style="width:50%;">
                            <tr><td>
                                     ...
                                     <input type="submit" name="add" value="Add Product" class="btn btn-success btn-group-justified"/>
                        </td></tr>
                </table>
            </center>
        </form></div>
...
if(isset($_POST["add"])){
    ...
    require '../connection.php';
              $q="insert into tbl_sproduct (pid,shopid,sellprice,quantity) values ('$pid','$shopid','$price','$quantity')";
              if(mysql_query($q)==1){
