			...
			<div class="clearfix">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                     ...
                     <li>
                         <a href="viewrewards.php" id="link">Rewards</a>
                    </li>
                     <li>
...
<script src="js/scripts.js"></script>
	<!--//scrolling js-->
        ...
        <a href="approveexpert.php">Approve Expert</a>
        <a href="approveshop.php">Approve Shop</a>
        <a href="approvefindings.php">Approve Findings</a>
        <a href="addoffer.php">New Offers</a>
        <a href="addreward.php">Rewards</a>
        <a href="viewfeedbacks.php">User Feedbacks</a>
